...
class ManagerService {
    ...
    public function getSaleLinesHistory($departementId, $startDate = null, $endDate = null) {
        $sql = "SELECT s.id AS sale_id, s.sold_at, si.product_name, si.quantity, si.unit_price,
...
include_once __DIR__ . '/../daophp/Stock_movementDAO.php';
...
include_once __DIR__ . '/ReportService.php';
...
class ManagerService {
    ...
    public function getDashboardSummary($departementId = null) {
        ...
        $overview = $this->departementDao->getDepartementOverview($departementId);
        if (!$overview) {
            return [
                'departementsCount' => 0,
                'employeesCount' => 0,
        ...
        return [
            ...
            'productsCount' => $overview['productsCount'],
            'lowStockProductsCount' => $overview['lowStockProductsCount'],
            'recentEmployee' => $this->getRecentEmployee($departementId),
            'recentReport' => $this->getRecentReport($departementId),
            'recentSale' => $this->getRecentSale($departementId),
        ];
    }
