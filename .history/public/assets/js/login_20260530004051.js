        ...
        try {
            ...
            if (response.ok && data.status === 'success') {
                ...
                if (data.user && data.user.role === 'patron') {
                    ...
                    window.location.href = '/1000saveursproject/public/manager/dashboardmanager.html';
                } else if (data.user && data.user.role === 'admin') {
                    window.location.href = '/1000saveursproject/public/admin/dashboardmanager.html';
                } else {
