...
const ManagerAPI = (function () {
    ...
    return {
        // CORRECTION 1: Récupérer les données utilisateur depuis l'API auth
        me: async () => {
            try {
        ...
        // CORRECTION 2: Ne pas appeler de page HTML via l'API
        dashboard: () => {
            console.log('Dashboard page already loaded');
            return Promise.resolve({ success: true, message: 'Already on dashboard page' });
        },
